...
<body>
	...
	<main id="main">
		...
		<?php
		include('link.php');
		$result = mysqli_query($con,"SELECT * FROM mess_push WHERE id='" . $_GET['id'] . "'");
		$row= mysqli_fetch_array($result);
		if(count($_POST)>0) {

			mysqli_query($con,"UPDATE mess_push set post_date='" . $_POST['post_date'] . "', remark='" . $_POST['remarks'] . "', spent_money='" . $_POST['spent_money'] . "' WHERE id='" . $_POST['userId'] . "'");

$message = "Record Modified Successfully";
	
			echo " <script> window.location.href='mess_ledger.php?message=$message';</script>";
			exit;
		}
			...
			<div class="row ">
				<div class="col-lg-10 col-md-10  text-center ">
					<form action="" name="frmUser" method="POST" enctype="multipart/form-data">
						...
						<label class=" font-weight-bold text-white form-control bg-success">Modify Post &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="cursor: pointer;"><a href="duty_post.php" class="text-white " >&nbsp; <i class="icofont-plus"></i> &nbsp;&nbsp;&nbsp; </a></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class="bg-primary text-white"><a href="mess_ledger.php" class="text-white">&nbsp; List &nbsp;&nbsp; </a> </span></label>
						...
						<div class="form-group">
							<div class="input-group">
								...
								<input id="datepicker" class="keyboard form-control" id="validationDefaultUsername" name="post_date" placeholder="date....." aria-describedby="inputGroupPrepend2"  value="<?php echo $row['post_date']?>" autocomplete="off" required >
							</div>
						</div>
						<!-- {{-- given money --}} -->
						<div class="form-group">
							<div class="input-group">
								...
								<input class="form-control" id="validationDefaultUsername" name="spent_money" placeholder="Given money ... " aria-describedby="inputGroupPrepend2" value="<?php echo $row['spent_money']?>"required>
							</div>
